...
## Audit #14 — since 610c432b
- ledger: 425 entries (+17 this window), 38 withdrawn
- rolls: 10 this window; runs: 4 (0 exited early, 0 contaminated)
- **2 thing(s) to look at:**
  - A273: rests on ONE run (watch-sendcount.log). Repeat it or say why one is enough.
  - cron: last push ended in a refusal/error — [daily-push] REFUSING: ledger check failed (see above). Fix the entries, not the checker.
- nothing flagged (quiet streak 1; at 3, halve the frequency)

## Audit #15 — since 964068df
- ledger: 442 entries (+17 this window), 38 withdrawn
- rolls: 10 this window; runs: 11 (8 exited early, 2 contaminated)
- **2 thing(s) to look at:**
  - runs: 2/11 had controller input -- not comparable to clean runs (T23).
  - cron: last push ended in a refusal/error — [daily-push] REFUSING: ledger check failed (see above). Fix the entries, not the checker.
- suppressed as superseded (6): A294 (single-run, justified in the entry); A293 (single-run, justified in the entry); A291 (single-run, justified in the entry); A290 (single-run, justified in the entry); A284 (single-run, justified in the entry); A280 (single-run, justified in the entry)

## Audit #16 — since a4767a72
- ledger: 448 entries (+6 this window), 38 withdrawn
- rolls: 5 this window; runs: 6 (0 exited early, 0 contaminated)
- **2 thing(s) to look at:**
  - T135: no evidence recorded. Say what was observed and when.
  - cron: last push ended in a refusal/error — [daily-push] REFUSING: ledger check failed (see above). Fix the entries, not the checker.
- suppressed as superseded (2): A298 (single-run, justified in the entry); A296 (single-run, justified in the entry)

## Audit #17 — since ce9936d5
- ledger: 469 entries (+21 this window), 38 withdrawn
- rolls: 7 this window; runs: 15 (0 exited early, 0 contaminated)
...
## Audit #19 — since 212c427e
- ledger: 519 entries (+19 this window), 38 withdrawn
- rolls: 11 this window; runs: 0 (0 exited early, 0 contaminated)
- **resolved since last audit (1):** A316 (single-run, open since #18)
- suppressed as superseded (5): A344 (single-run, justified in the entry); A343 (single-run, justified in the entry); A342 (single-run, justified in the entry); A331 (single-run, justified in the entry); A329 (single-run, justified in the entry)
- nothing flagged (quiet streak 1; at 3, halve the frequency)

## Audit #20 — since bb6872c8
- ledger: 532 entries (+13 this window), 38 withdrawn
- rolls: 11 this window; runs: 2 (0 exited early, 0 contaminated)
...
## Audit #30 — since 053003e0
- ledger: 762 entries (+13 this window), 42 withdrawn
- rolls: 10 this window; runs: 0 (0 exited early, 0 contaminated)
- **1 thing(s) to look at:**
...
## Audit #32 — since 197ab566
- ledger: 783 entries (+11 this window), 42 withdrawn
- rolls: 10 this window; runs: 1 (0 exited early, 0 contaminated)
- **1 thing(s) to look at:**
  - cron: last logged run refused ([daily-push] REFUSING: ledger check failed (see above). Fix ) and 178 commit(s) are unpushed. **This may be history** — commits accumulate normally between nightly runs. Settle it with `scripts/daily_push.sh --dry-run`.

## Audit #33 — since 708a6af5
- ledger: 807 entries (+24 this window), 42 withdrawn
...
## Audit #36 — since 96b31ab2
- ledger: 899 entries (+26 this window), 42 withdrawn
- rolls: 20 this window; runs: 9 (1 exited early, 0 contaminated)
...
## Audit #38 — since bd533bce
- ledger: 965 entries (+24 this window), 42 withdrawn
- rolls: 10 this window; runs: 0 (0 exited early, 0 contaminated)
